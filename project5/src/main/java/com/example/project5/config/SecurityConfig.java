...
public class SecurityConfig {
    ...
    /*
    @Bean
    // 로그인/로그아웃 기능을 테스트 하기 위한 가상의 사용자 정보 생성
    ...
    */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // CSRF 토큰을 요구함.
        // POST/PUT/DELETE 요청에서 CSRF 토큰을 서버로 전송하지 않으면 403 에러가 발생.
        // 기능 구현을 간단히 하기 위해서 Spring Security의 CSRF의 기능을 비활성화.
        http.csrf().disable();
        ...
        http.authorizeHttpRequests() // 요청에 따른 권한 설정 시작.
            ...
            */
        // -> 새로운 요청 경로/컨트롤러가 생길 때마다 설정 자바 코드를 변경을 해야하는 번거로움이 있음
